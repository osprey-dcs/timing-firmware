...
#set_property -dict {PACKAGE_PIN F17 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports {FMC1_CLK0_M2C_P}]
#set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports {FMC1_CLK0_M2C_N}]
#create_clock -period 8.000 -name FMC1_CLK0_C2M [get_ports {FMC1_CLK0_M2C_P}]

# FMC1_CLK1_M2C -- FMC1 G2/G3
#set_property -dict {PACKAGE_PIN E18 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports {FMC1_CLK1_M2C_P}]
#set_property -dict {PACKAGE_PIN D18 IOSTANDARD LVDS_25 DIFF_TERM TRUE} [get_ports {FMC1_CLK1_M2C_N}]
#create_clock -period 8.000 -name FMC1_CLK1_M2C [get_ports {FMC1_CLK1_C2M_P}]

############################# GPIO #############################
# FMC1 LA00 -- FMC1 G6/G7
# FIXME!  should be from correct FMC pin -- hardware not yet defined so use this as a placeholder for now!
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS25} [get_ports FMC1_PPS_MARKER]
