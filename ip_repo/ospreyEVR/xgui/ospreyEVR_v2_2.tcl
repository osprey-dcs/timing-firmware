...
proc update_PARAM_VALUE.ACTIVE_LOW_OUTPUTS { PARAM_VALUE.ACTIVE_LOW_OUTPUTS } {
	# Procedure called to update ACTIVE_LOW_OUTPUTS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ACTIVE_LOW_OUTPUTS { PARAM_VALUE.ACTIVE_LOW_OUTPUTS } {
	# Procedure called to validate ACTIVE_LOW_OUTPUTS
	return true
}
...
proc update_PARAM_VALUE.SERDES_FACTOR { PARAM_VALUE.SERDES_FACTOR } {
	# Procedure called to update SERDES_FACTOR when any of the dependent parameters in the arguments change
}
...
proc update_MODELPARAM_VALUE.SERDES_FACTOR { MODELPARAM_VALUE.SERDES_FACTOR PARAM_VALUE.SERDES_FACTOR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
